...
ConfigEntry ConfigFile[] =
{
    ...
    {"HKKey_CycleScreenLayout",   0, &HKKeyMapping[HK_CycleScreenLayout],   -1},
    {"HKKey_CycleScreenSizing",   0, &HKKeyMapping[HK_CycleScreenSizing],   -1},
    {"HKKey_CycleScreenRotation", 0, &HKKeyMapping[HK_CycleScreenRotation], -1},
    ...
    {"HKJoy_CycleScreenRotation", 0, &HKJoyMapping[HK_CycleScreenRotation], -1},
